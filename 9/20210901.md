...
<div class="searchResult">
    ...
    <%
        ...
        if( boardList!=null){
            ...
            int serialNo = (Integer)request.getAttribute("selectPageNo") 
            ...
            for( int i=0; i<boardList.size(); i++ ){
                ...
                out.println("<tr style='cursor: pointer;' onclick='goBoardContentForm("+b_no+")'><td>"+ (serialNo++) +"<td>" + xxx + subject + "<td>"+writer+"<td>"+readcount+"<td>"+reg_date);
