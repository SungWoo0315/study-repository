...
### <49> mployee 테이블에서 직원번호, 직원명, 입사일(년-월-일) 검색하면?  
...
### <50> mployee 테이블에서 직원번호, 직원명, 나이 검색하면?  
...
### <51> mployee 테이블에서 직원번호, 직원명, 근무년차를 검색해서 출력하면?
...
### <52> mployee 테이블에서 직원번호, 직원명, 연령대를 검색해서 출력하면?
